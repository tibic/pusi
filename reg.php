...
$check_query = mysql_query("select uid from users where email='$email' limit 1");
if(mysql_fetch_array($check_query)){
...
$regdate = time();
$sql = "INSERT INTO users(uid,username,password,email,regdate)VALUES('','$username','$password','$email',
$regdate)";
